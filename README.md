Analytic code from "Prospective facility-based hybrid surveillance to estimate the Incidence and Antimicrobial Resistance of Shigella-Attributable Diarrhea in Young Children in Low- and Middle-Income Countries (LMICs): Results from the multi-country Enterics for Global Health (EFGH) Shigella Surveillance Study" published by Yousafzai MT, Cornick J, Yori PP, Hossain MdJ, Keita AM, Atlas HE, Khanam F, Omore R, Galagan SR, et al in Lancet GLobal Health (add DOI here). All data used in analyses can be found in a Vivli data repository (https://doi.org/10.25934/PR00011860). While the majority of analyses can be replicated, data were anonymized and not all data sources used in the analysis are available.
